      ...
      <div className="bg-[#2f3555] mt-25">
        <Container>
          <div className="pt-25">
            ...
            <h1 className="text-[48px] text-white font-semibold w-[640px] mx-auto">
          ...
          <Flex className="mt-18.75 gap-7">
            <div className="w-86 text-white bg-[#FFFFFF1A] px-10 pt-10 rounded-[20px] hover:bg-[#734BDF] transition-1.3s">
              ...
              <h1 className="text-[20px] font-bold pb-3">
              ...
              <button className="text-[16px] font-bold pb-10 pt-8">
                Read More
              </button>
            </div>
          ...
          <p className="text-white w-155.5 mx-auto pt-15.5 pb-5.5">
